...
public class IteratorOfIteratorsTest {
    ...
    @Before
    public void setUp() {
        Iterator<Integer> itFirst = Arrays.asList(1, 2, 3).iterator();
        Iterator<Integer> itSecond = Arrays.asList(4, 5, 6).iterator();
        Iterator<Integer> itThird = Arrays.asList(7, 8, 9).iterator();
        Iterator<Iterator<Integer>> its = Arrays.asList(itFirst, itSecond, itThird).iterator();
