...
public class Zip {
    ...
    public static void main(String[] args) {
        ...
        List<File> files = seekBy(options.getOptionValue(DIRECTORY_OPTION), new ExcludeFileFilter(options.getOptionValue(EXCLUDE_OPTION)));
        try {
            pack(files, new File(options.getOptionValue(OUTPUT_OPTION)));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
